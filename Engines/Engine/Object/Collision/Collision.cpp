...
bool MLEngine::Object::Collision::IsCollision(const Sphere& s1, const Sphere& s2) {
...
bool MLEngine::Object::Collision::IsCollision(const Sphere& sphere, const Plane& plane) {
...
bool MLEngine::Object::Collision::IsCollision(const Segment& segment, const Plane& plane) {
...
bool MLEngine::Object::Collision::IsCollision(const Segment& segment, const Triangle& triangle) {
...
bool MLEngine::Object::Collision::IsCollision(const AABB& aabb1, const AABB& aabb2) {
...
bool MLEngine::Object::Collision::IsCollision(const AABB& aabb, const Sphere& sphere) {
...
bool MLEngine::Object::Collision::IsCollision(const AABB& aabb, const Segment& segment) {
...
bool MLEngine::Object::Collision::IsCollision(const OBB& obb, const Sphere& sphere) {
	...
	//ローカル空間で衝突判定
	if (MLEngine::Object::Collision::IsCollision(aabbOBBLocal, sphereOBBLocal)) {
		return true;
	}
...
bool MLEngine::Object::Collision::IsCollision(const Sphere& sphere, const OBB& obb) {

	return MLEngine::Object::Collision::IsCollision(obb, sphere);

}

bool MLEngine::Object::Collision::IsCollision(const OBB& obb, const Segment& segment) {
	...
	return MLEngine::Object::Collision::IsCollision(localAABB, localSegment);

}

bool MLEngine::Object::Collision::IsCollision(const Segment& segment, const OBB& obb) {

	return MLEngine::Object::Collision::IsCollision(obb, segment);

}

//OBB同士の当たり判定
bool MLEngine::Object::Collision::IsCollision(const OBB& obb1, const OBB& obb2) {
...
bool MLEngine::Object::Collision::IsCollision(const OBB& obb, const Vector3& point)
{
...
bool MLEngine::Object::Collision::IsWrapped(const OBB& outSide, const OBB& inside)
{
	...
	for (int32_t i = 0; i < points.size(); i++) {
		...
		if (not MLEngine::Object::Collision::IsCollision(outSide, points[i])) {
			return false;
		}
