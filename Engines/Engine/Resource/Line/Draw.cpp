...
void MLEngine::Resource::DrawSphere(const Sphere& sphere, const Matrix4x4& viewProjectionMatrix,
...
void MLEngine::Resource::DrawGrid(const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix) {
...
void MLEngine::Resource::DrawPlane(const Plane& plane, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix) {
	//中心点を決める
...
void MLEngine::Resource::DrawTriangle(const Triangle& triangle, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix) {
...
void MLEngine::Resource::DrawAABB(const AABB& aabb, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix) {
